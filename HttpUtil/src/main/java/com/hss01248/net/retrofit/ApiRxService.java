...
public interface ApiRxService {
    ...
    @GET()
    Observable<BaseNetBean> executGet(@Url String url, @QueryMap Map<String, String> params, @HeaderMap Map<String, String> headers);
...
//
    ...
    @GET()
    <T>  Call<BaseNet<T>> getStandradJson(@Url String url, @QueryMap Map<String, String> maps);
